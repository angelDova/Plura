...
const SubaccountsPage = async ({ params }: Props) => {
  ...
  return (
    <>
      <h1 className="text-4xl p-4">Sub Accounts</h1>
            ...
            <CommandList>
              ...
              <CommandGroup heading="Sub Accounts">
                {!!user.Agency?.SubAccount.length ? (
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription className="text-left">
                            This action can&apos;t be undone. This will delete
                            the subaccount and all the data related to it.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                  ...
                  <div className="text-muted-foregorund text-center p-4">
                    No Sub Accounts
                  </div>
                )}
              </CommandGroup>
